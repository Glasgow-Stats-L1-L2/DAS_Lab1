...
* [This blog post](https://simplystatistics.org/2019/08/28/you-can-replicate-almost-any-plot-with-ggplot2/) shows that you can replicate almost any plot with R.

***

It is advisable to record the code you create throughout this tutorial as a handy summary in an `.R` script file. You will be required to create and write your own script file in the "Further Tasks" section at the end of the session, but the given R code will help you engage with the material directly as you work through the following sections. Start by loading into R all of the libraries we will need for this session. This can be done by typing/copying the following code into your R script and "running" the code: 
